...
{
  "db_name": "mojoTalk", # Database name (only used for debugging)
  "db_file": "data/users/mojotalk.db", # Database file relative to site's directory
...
```json
{
  ...
  "includes": {
    "13v1FwKcq7dx2UPruFcRcqd8s7VBjvoWJW/content.json": {
      ...
      "max_size": 10000,
      "signers": ["13v1FwKcq7dx2UPruFcRcqd8s7VBjvoWJW"],
      "signers_required": 1,
      "user_id": 15,
    ...
    "15WGMVViswrF13sAKb7je6oX3UhXavBxxQ/content.json": {
      ...
      "includes_allowed": false,
      "max_size": 10000,
      "signers": ["15WGMVViswrF13sAKb7je6oX3UhXavBxxQ"],
      "signers_required": 1,
      "user_id": 18,
      "user_name": "habla"
    }
